 ...
 */
class NumerosTelefonicos extends \EAMBundle\Entity\NumerosTelefonicos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EAMBundle\\Entity\\NumerosTelefonicos' . "\0" . 'codigo', '' . "\0" . 'EAMBundle\\Entity\\NumerosTelefonicos' . "\0" . 'numero', '' . "\0" . 'EAMBundle\\Entity\\NumerosTelefonicos' . "\0" . 'tipo', '' . "\0" . 'EAMBundle\\Entity\\NumerosTelefonicos' . "\0" . 'idPaciente', '' . "\0" . 'EAMBundle\\Entity\\NumerosTelefonicos' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NumerosTelefonicos $proxy) {
