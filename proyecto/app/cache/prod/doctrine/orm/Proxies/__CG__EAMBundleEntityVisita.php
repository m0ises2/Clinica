 ...
 */
class Visita extends \EAMBundle\Entity\Visita implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EAMBundle\\Entity\\Visita' . "\0" . 'fecha', '' . "\0" . 'EAMBundle\\Entity\\Visita' . "\0" . 'hora', '' . "\0" . 'EAMBundle\\Entity\\Visita' . "\0" . 'idPaciente', '' . "\0" . 'EAMBundle\\Entity\\Visita' . "\0" . 'idMedico', '' . "\0" . 'EAMBundle\\Entity\\Visita' . "\0" . 'id');
        }
