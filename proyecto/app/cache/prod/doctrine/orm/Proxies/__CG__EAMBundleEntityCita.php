 ...
 */
class Cita extends \EAMBundle\Entity\Cita implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EAMBundle\\Entity\\Cita' . "\0" . 'fecha', '' . "\0" . 'EAMBundle\\Entity\\Cita' . "\0" . 'hora', '' . "\0" . 'EAMBundle\\Entity\\Cita' . "\0" . 'motivo', '' . "\0" . 'EAMBundle\\Entity\\Cita' . "\0" . 'idPaciente', '' . "\0" . 'EAMBundle\\Entity\\Cita' . "\0" . 'id');
        }
