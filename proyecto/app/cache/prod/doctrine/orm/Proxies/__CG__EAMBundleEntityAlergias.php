 ...
 */
class Alergias extends \EAMBundle\Entity\Alergias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EAMBundle\\Entity\\Alergias' . "\0" . 'descripcion', '' . "\0" . 'EAMBundle\\Entity\\Alergias' . "\0" . 'fecha', '' . "\0" . 'EAMBundle\\Entity\\Alergias' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Alergias $proxy) {
