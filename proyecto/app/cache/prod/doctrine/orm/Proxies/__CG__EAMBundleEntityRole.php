 ...
 */
class Role extends \EAMBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EAMBundle\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'EAMBundle\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'EAMBundle\\Entity\\Role' . "\0" . 'role', '' . "\0" . 'EAMBundle\\Entity\\Role' . "\0" . 'users');
        }
